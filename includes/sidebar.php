<nav class="dashboard-nav">
    ...
    <div class="nav-links">
        ...
        <a href="/admin/team-communication.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'team-communication.php' ? 'active' : ''; ?>">
            <i class="fab fa-whatsapp"></i>
            <span data-en="WhatsApp" data-hi="व्हाट्सएप">व्हाट्सएप</span>
        </a>
